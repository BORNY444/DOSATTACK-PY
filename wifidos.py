...
print("                                                               ")
print("""BLAINE IS HERE SCRIPT KIDDIES HHHHHHHHHHHH SO LETS START""")
print("                                                               ")
print("\n_____________________________________________________________")
print("\n WARNING: BENESBA LDRARI LI GHAYSTAKHDMO SCRIPT ON KALI LUNIX BLA CHAR7 MOFASSAL")
print("\n GHADI TL9AW BELI NETWORK MANAGER MAKHEDAMCHE MNI GHATSALIW HADI 7AJA 3ADIYA SO GHA ")
print("\n T7OL TERMINAL OU GHATKTEB __sudo service NetworkManager start__ SF O GHAYRJA3 YE9RA LIK LWIFIYATE ")
